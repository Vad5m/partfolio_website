(function() {
    ...
    const PARTFOLIO_URL = window.PARTFOLIO_URL;
    const DELETE_PROJECT_URL_BASE = window.DELETE_PROJECT_URL_BASE;
            ...
            if (editBtn) {
                const editHandler = function(e) {
                    ...
                    try {
                        ...
                        showToast('Ошибка загрузки данных проекта', 'error');
                    }
                };
    ...
    if (confirmDeleteBtn) {
        confirmDeleteBtn.addEventListener('click', function() {
            if (pendingDeleteId) {
                ...
                form.method = 'POST';
                form.action = DELETE_PROJECT_URL_BASE + pendingDeleteId;
